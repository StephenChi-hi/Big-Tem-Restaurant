...
const ProductCard: React.FC<ProductCardProps> = ({
  ...
  return (
    ...
    >
      <div className="bg-white p-2 relative hover:border-primary overflow-hidden border rounded-lg ">
        ...
        <div className=" flex flex-col justify-center border-t pt-2 items-center   ga -rounded-lg  bg-white bg-opacity-65">
          <p className=" font-medium text-[14px] text-center  whitespace-nowrap w-[100%] truncate overflow-hidden">
            {" "}
            {title}{" "}
          </p>
