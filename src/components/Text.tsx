...
const body_Font_Medium = localFont({
  src: "../app/fonts/Poppins/fonts/Poppins-Medium.ttf",
});

const body_Font_Regular = localFont({
  src: "../app/fonts/Poppins/fonts/Poppins-Regular.ttf",
});

const body_Font_Light = localFont({
  src: "../app/fonts/Poppins/fonts/Poppins-Light.ttf",
});

const body_Font_Bold = localFont({
  src: "../app/fonts/Poppins/fonts/Poppins-Bold.ttf",
});
...
export const Paragraph1: React.FC<{
  ...
  <h1
    className={`text-[14px] sm:text-[14px] md:text-[16px] lg:text-[16px]  leading-[24px] sm:leading-[28px] md:leading-[32px] lg:leading-[36px] xl:leading-[38px] 2xl:leading-[40px]  ${body_p_regular.className} ${className}`}
  >
    {children}
  </h1>
);
...
export const Paragraph2: React.FC<{
  ...
  <p
    className={`text-[14px] sm:text-[14px]  leading-[24px] sm:leading-[28px] md:leading-[32px] lg:leading-[36px] xl:leading-[38px] 2xl:leading-[40px]   ${body_p_regular.className} ${className}`}
  >
    {children}
  </p>
);
...
export const Paragraph3: React.FC<{
  ...
  <p
    className={`text-[14px] sm:text-[14px] md:text-[16px] lg:text-[17px]  leading-[24px] sm:leading-[28px] md:leading-[32px] lg:leading-[36px] xl:leading-[38px] 2xl:leading-[40px]   ${body_p_light.className} ${className}`}
  >
    {children}
  </p>
);
...
export const ParagraphLink1: React.FC<{
  ...
  <h1
    className={`text-[14px] sm:text-[14px] md:text-[16px] lg:text-[16px]  leading-[24px] sm:leading-[28px] md:leading-[32px] lg:leading-[36px] xl:leading-[38px] 2xl:leading-[40px] hover:scale-105 transition-transform duration-300  ${body_Font_Regular.className} ${className}`}
  >
    {children}
  </h1>
);
