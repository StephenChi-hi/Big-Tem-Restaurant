...
import countries from "./SchoolsWithLogo";
                ...
                >
                  <div className="flex justify-between items-center">
                    ...
                    {editCountryFee === country.name ? (
                      ...
                      // Normal View
                      <div
                        className="borde px-2 py-1 min-w-[50px] rounded-lg cursor-pointer"
                        ...
                        {country.states.map((state: any) => (
                          ...
                          >
                            ...
                            {editStateFee === state.id ? (
                              ...
                              // Normal View
                              <div
                                className=" px-2 py-1 w-fit whitespace-nowrap rounded-lg cursor-pointer"
