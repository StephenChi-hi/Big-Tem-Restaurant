      ...
      <div className=" container1 py-[24px] xl:py-[100px] pt-[100px]  text-p_black">
        ...
        >
          <Header3>
            ...
            <span className="text-primary text-center">Healthy Eating</span> and
            Wellness
          </Header3>
          <Paragraph1 className="max-w-[883px] text-center">
            Welcome to our food and wellness blog, your go-to source for the
            latest tips, recipes, and updates in the world of healthy living.
            Here, we celebrate the joy of wholesome meals and inspire a
            lifestyle full of flavor, balance, and vitality.
          </Paragraph1>
        </div>
        {/* data-aos="fade-right" */}
