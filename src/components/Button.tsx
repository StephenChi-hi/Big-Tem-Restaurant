...
const Button: React.FC<ButtonProps> = ({
  ...
  const commonClasses = `relative overflow-hidden group ${backgroundColor} ${color} ${border} ${body_Font.className} px-[24px] py-[10px] font-medium  text-[14px] sm:text-[14px]  rounded-lg cursor-pointer text-center ${additionalClasses}`;
